(() => {
  ...
  function updateNavigation() {
    ...
    if (contact) { contact.href = '#contact'; contact.textContent = 'Email Us'; contact.removeAttribute('target'); contact.removeAttribute('rel'); contact.removeAttribute('data-page'); contact.setAttribute('aria-label', 'Email BNB'); }
